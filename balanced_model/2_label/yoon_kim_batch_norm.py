...
glmp1_1 = MaxPooling1D(pool_size = 8)(actv1_2)
...
glmp2_1 = MaxPooling1D(pool_size = 8)(actv2_2)
...
glmp3_1 = MaxPooling1D(pool_size = 8)(actv3_2)
...
glmp4_1 = MaxPooling1D(pool_size = 8)(actv4_2)

# Gather all convolution layers
cnct = concatenate([glmp1_1, glmp2_1, glmp3_1, glmp4_1], axis=1)
drp = Dropout(drop_out_rate)(cnct)

dns1  = Dense(64, activation='relu',kernel_regularizer=regularizers.l2(l2_pen))(drp)
btch1 = BatchNormalization()(dns1)
drp1  = Dropout(drop_out_rate)(btch1)
dns2  = Dense(32, activation='relu',kernel_regularizer=regularizers.l2(l2_pen))(drp1)
