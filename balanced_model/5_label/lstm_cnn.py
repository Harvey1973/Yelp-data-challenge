...
activations = LSTM(units, return_sequences = True,dropout = 0.5,recurrent_dropout = 0.5 ,kernel_regularizer=regularizers.l2(0.1))(embedded_sequences)
...
conv2_1 = Conv1D(filters=conv_filters, kernel_size=4,kernel_regularizer=regularizers.l2(0.2))(activations)
...
conv3_1 = Conv1D(filters=conv_filters, kernel_size=5,kernel_regularizer=regularizers.l2(0.2))(activations)
...
conv4_1 = Conv1D(filters=conv_filters, kernel_size=6,kernel_regularizer=regularizers.l2(0.2))(activations)
...
with open(r"/usr4/cs542sp/zzjiang/History/5_label/lstm_cnn", "wb") as output_file:
